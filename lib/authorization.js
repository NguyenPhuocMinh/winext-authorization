...
function Authorization(params = {}) {
  ...
  this.noVerifyToken = async function (request, response, next) {
    try {
      ...
      loggerTracer.debug(chalk.blue(`Load function noVerifyToken by ${name}-${version} successfully!`));
  ...
  this.verifyTokenMiddleware = async function (request, response, next) {
    try {
      ...
      loggerTracer.debug(chalk.blue(`Load function verifyTokenMiddleware by ${name}-${version} successfully!`));
  ...
  this.publicRouters = async function (request, response, next) {
    try {
      ...
      loggerTracer.debug(chalk.blue(`Load function publicRouters by ${name}-${version} successfully!`));
  ...
  this.protectedRouters = async function (request, response, next) {
    try {
      ...
      loggerTracer.debug(chalk.blue(`Load function protectedRouters by ${name}-${version} successfully!`));
